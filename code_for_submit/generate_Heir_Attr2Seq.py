...
from models import  FusionTransformerModel, SumEvaluator, denumericalize,type_label
from model_Hier_Attr2Seq import Hier_Attr2Seq_model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', default="./ExpansionNet_Hie/default_op2text_default_epoch-1.pt", type=str)
    ...
    for batch_idx, batch in enumerate(test_iterator):
        ...
        if g_conf["method"] == "greedy":
            ...
            beam_width = 3
            # print(batch["input_text"].to(device))
            # print(batch["aspect_type"].to(device))
            # print(batch["user"].to(device).shape)
