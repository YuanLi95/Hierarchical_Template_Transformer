...
from model_Hier_Attr2Seq import LabelSmoothingLoss, SumEvaluator, denumericalize,type_label,Hier_Attr2Seq_model
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--model_name', default="Review_Base_Transformer", type=str)
    parser.add_argument('--model_name', default="ExpansionNet_Hie", type=str)
    ...
    model = Hier_Attr2Seq_model(absa_dataset.input_text_embedding,
    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx, batch in enumerate(tqdm(train_iterator)):
            ...
            optimizer.zero_grad()
            opinion_outputs_list, review_outputs,review_input = model(
