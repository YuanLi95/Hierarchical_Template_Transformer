...
from models_Base_Trans import Base_Transformer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', default="./Review_Base_Transformer/default_op2text_default_epoch-4.pt", type=str)
